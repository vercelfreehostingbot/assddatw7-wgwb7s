...
public class httputils2service extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "com.psiphon289", "com.psiphon289.httputils2service");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "com.psiphon289.httputils2service", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static anywheresoftware.b4h.okhttp.OkHttpClientWrapper _vvvvvvvvvv1 = null;
public static anywheresoftware.b4a.objects.collections.Map _vvvvvvvvv0 = null;
...
public static String  _vvvvvvvvv7(int _taskid,boolean _success,String _errormessage) throws Exception{
...
_job = (com.psiphon289.httpjob)(_vvvvvvvvv0.Get((Object)(_taskid)));
...
anywheresoftware.b4a.keywords.Common.LogImpl("11179653","HttpUtils2Service (hc_ResponseError): job completed multiple times - "+BA.NumberToString(_taskid),0);
 //BA.debugLineNum = 115;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 117;BA.debugLine="job.Response = Response";
_job._vvvvvvvv3 /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse*/  = _response;
...
_vvvvvvvvv7(_taskid,anywheresoftware.b4a.keywords.Common.False,_response.getErrorResponse());
 }else {
 //BA.debugLineNum = 121;BA.debugLine="CompleteJob(TaskId, False, Reason)";
_vvvvvvvvv7(_taskid,anywheresoftware.b4a.keywords.Common.False,_reason);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("11048579","HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "+BA.NumberToString(_taskid),0);
...
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(_vvv0,BA.NumberToString(_taskid),anywheresoftware.b4a.keywords.Common.False);
...
_vvvvvvvvvv1 = new anywheresoftware.b4h.okhttp.OkHttpClientWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Private TaskIdToJob As Map";
_vvvvvvvvv0 = new anywheresoftware.b4a.objects.collections.Map();
...
_vvvvvvvvv7(_taskid,_success,"");
 }else {
 //BA.debugLineNum = 105;BA.debugLine="CompleteJob(TaskId, Success, LastException.Messa";
_vvvvvvvvv7(_taskid,_success,anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage());
 };
...
_vvv0 = anywheresoftware.b4a.keywords.Common.File.getDirInternalCache();
 //BA.debugLineNum = 30;BA.debugLine="Try";
try { //BA.debugLineNum = 31;BA.debugLine="File.WriteString(TempFolder, \"~test.test\", \"test";
anywheresoftware.b4a.keywords.Common.File.WriteString(_vvv0,"~test.test","test");
 //BA.debugLineNum = 32;BA.debugLine="File.Delete(TempFolder, \"~test.test\")";
anywheresoftware.b4a.keywords.Common.File.Delete(_vvv0,"~test.test");
 } 
       catch (Exception e6) {
...
_vvv0 = anywheresoftware.b4a.keywords.Common.File.getDirInternal();
 };
 //BA.debugLineNum = 41;BA.debugLine="If hc.IsInitialized = False Then";
if (_vvvvvvvvvv1.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 46;BA.debugLine="hc.Initialize(\"hc\")";
_vvvvvvvvvv1.Initialize("hc");
 };
...
public static String  _submitjob(com.psiphon289.httpjob _job) throws Exception{
int _taskid = 0;
...
_vvvvvvvvvv2 = (int) (_vvvvvvvvvv2+1);
 //BA.debugLineNum = 74;BA.debugLine="Dim TaskId As Int = taskCounter";
_taskid = _vvvvvvvvvv2;
 //BA.debugLineNum = 76;BA.debugLine="TaskIdToJob.Put(TaskId, job)";
_vvvvvvvvv0.Put((Object)(_taskid),(Object)(_job));
 //BA.debugLineNum = 77;BA.debugLine="If job.Username <> \"\" And job.Password <> \"\" Then";
if ((_job._vvvvvvv5 /*String*/ ).equals("") == false && (_job._vvvvvvv6 /*String*/ ).equals("") == false) { 
 //BA.debugLineNum = 78;BA.debugLine="hc.ExecuteCredentials(job.GetRequest, TaskId, jo";
_vvvvvvvvvv1.ExecuteCredentials(processBA,_job._vvvvv5 /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ (),_taskid,_job._vvvvvvv5 /*String*/ ,_job._vvvvvvv6 /*String*/ );
 }else {
 //BA.debugLineNum = 80;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
_vvvvvvvvvv1.Execute(processBA,_job._vvvvv5 /*anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest*/ (),_taskid);
 };
