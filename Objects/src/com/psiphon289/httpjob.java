...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.psiphon289.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.psiphon289.httpjob.class).invoke(this, new Object[] {null});
        else
...
public String _vvvvvvv6 = "";
public String _vvvvvvv7 = "";
public Object _vvvvvvv0 = null;
public String _vvvvvvvv1 = "";
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvvv2 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvvv3 = null;
...
public com.psiphon289.firebasemessaging _vvvvvvvvv2 = null;
...
public String  _vvvv2(String _link) throws Exception{
...
if ((_vvvvvvvv6).equals("") || _link.contains(":")) { 
if (true) return _link;};
 //BA.debugLineNum = 45;BA.debugLine="Return DefaultScheme & \"://\" & Link";
if (true) return _vvvvvvvv6+"://"+_link;
...
_vvvvvvvv2.InitializeDelete(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializeDelete(_vvvvvvvv5);
 };
 //BA.debugLineNum = 260;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvv3.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return "";
}
public String  _vvvv5(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvv2.InitializeDelete(_vvvv0(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializeDelete(_vvvv0(_vvvvvvvv5,_parameters));
 };
...
public String  _vvvv6(String _link) throws Exception{
...
_vvvvvvvv2.InitializeGet(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializeGet(_vvvvvvvv5);
 };
...
public String  _vvvv7(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvv2.InitializeGet(_vvvv0(_link,_parameters));
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializeGet(_vvvv0(_vvvvvvvv5,_parameters));
 };
...
public String  _vvvv0(String _link,String[] _parameters) throws Exception{
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvv1() throws Exception{
...
_b = __c.LoadBitmap(_vvvvvvvvv3._vvv0 /*String*/ ,_vvvvvvvv1);
 //BA.debugLineNum = 324;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 325;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvv2(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvvvvvvvv3._vvv0 /*String*/ ,_vvvvvvvv1,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 334;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvv3(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvvvvvvvv3._vvv0 /*String*/ ,_vvvvvvvv1,_width,_height);
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvvv4() throws Exception{
...
_in = __c.File.OpenInput(_vvvvvvvvv3._vvv0 /*String*/ ,_vvvvvvvv1);
 //BA.debugLineNum = 341;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvvv5() throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvvvvvv3._vvv0 /*String*/ ,_vvvvvvvv1).getObject()),_encoding);
...
public String  _vvvvv0(String _link) throws Exception{
...
_vvvvvvvv2.InitializeHead(_link);
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializeHead(_vvvvvvvv5);
 };
...
_vvvvvvv0 = _targetmodule;
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvv1(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
public String  _vvvvvv2(String _link,byte[] _data) throws Exception{
...
_vvvvvvvv2.InitializePatch2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializePatch2(_vvvvvvvv5,_data);
 };
...
public String  _vvvvvv3(String _link,String _text) throws Exception{
...
_vvvvvv2(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 85;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvv4(String _link,byte[] _data) throws Exception{
...
_vvvvvvvv2.InitializePost2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializePost2(_vvvvvvvv5,_data);
 };
...
public String  _vvvvvv5(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_vvvvvv4(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 203;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvvv2.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvvv6(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
String _value = "";
String _s = "";
com.psiphon289.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_empty = _vvvvvv1(_stream,_empty);
...
_fd = (com.psiphon289.httpjob._multipartfiledata)(group17.Get(index17));
...
_vvvvvv4(_link,_text.getBytes("UTF8"));
...
_vvvvvvvv2.InitializePut2(_link,_data);
 } 
       catch (Exception e5) {
...
_vvvvvvvv2.InitializePut2(_vvvvvvvv5,_data);
 };
...
public String  _vvvvvvv1(String _link,String _text) throws Exception{
...
__c.File.Delete(_vvvvvvvvv3._vvv0 /*String*/ ,_vvvvvvvv1);
